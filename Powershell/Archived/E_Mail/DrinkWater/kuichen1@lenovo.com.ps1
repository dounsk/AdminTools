...
# --- Set The Mail Body
$body = "哟，奎哥你好, 我是你的提醒喝水小助手，这是今天的第"+$Water +"轮，希望此刻看到消息的人可以和我一起来一杯水, 忙碌之余也要记得喝水呀。今日目标：250ml * 8杯，任务达成 （"+$Water+" / 8 ）。和我一起成为一天八杯水的人吧！ \^o^/"


# --- Send Email
Send-OutlookMail -Recipient kuichen1@lenovo.com -Subject $Subject -body $body -FilePath C:\Users\TOM\Documents\Mail\DrinkWater\Water.jpg -SendImmediately #Send Now