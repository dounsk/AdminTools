...
# --- Update The Mail Attachment
powershell C:\Users\TOM\Documents\Mail\Show-Calendar.ps1

# --- Set The Mail Subject
$Subject = "Shared Calendar_$(Get-Date -Format 'yyyyMMdd')"

# --- Set The Mail Body
$body =  "Hi All, The file has been updated at $(Get-Date -Format 'yyyy/MM/dd HH:mm'), please check the attachment, thank you. "

# --- Wait for the attachment updated
Start-Sleep -Seconds 5

# --- Send Email
Send-OutlookMail -Recipient tom@8088.ink -Subject $Subject -body $body -FilePath C:\Users\TOM\Documents\Mail\Calendar.txt  -SendImmediately #Send Now